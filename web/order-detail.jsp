<%-- 
    ...
    Created on : Nov 3, 2023, 8:23:23 AM
    Author     : DELL
--%>
                        ...
                        <div class="container">
                            ...
                            <div class="checkout__form">
                                ...
                                <div class="row d-flex justify-content-between">
                                    <button type="button" class="site-btn m-0 p-1"><a href="home" class="primary-btn mx-auto">Trang chủ</a></button><!--  -->
                                    <button type="button" class="site-btn m-0 p-1"><a href="purchase" class="primary-btn mx-auto">Quay lại đơn mua</a></button>
                                </div>
