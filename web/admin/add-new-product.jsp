<%-- 
    ...
    Created on : Nov 8, 2023, 7:50:14 PM
    Author     : DELL
--%>
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <center class='mt-5'><h1>Thêm mới sản phẩm</h1></center>
                <form method="post" action="add-new-product" class='row p-0 m-0'>
                    <div class="col-lg-6 p-3">
                        Tên: <input class='input-auto' type="text" name='productName'><br>
                        Ảnh <input class='input-auto' type="text" name='productImage'> <br>
                        Mô tả <textarea id="summernote" name='productDescription' style="background-color: #fff; color: #000;">${product.description}</textarea>
                        <br>
                        ...
                        <div id="category">
                            ...
                            <c:forEach items="${listTypes}" var="type">
                                <input type="checkbox" id="type${type.id}" name="type" value="${type.id}" class="hidden-checkbox">
                                <label for="type${type.id}">${type.name}</label>
                            </c:forEach>

                        </div>
                        <img class="img-fluid mt-5" src="" alt="alt"/>
                    </div>
                    <div class='col-lg-6 p-3'>
                        <h2>Biến thể</h2>
                        ...
                        <button type="button" id="add-variant-btn" class="add-btn">Thêm biến thể</button>
        ...
        <script type="text/javascript">
            function addOption(button) {
                ...
                if (newOptionValue && newOptionSku) {
                    ...
                    optionsList.innerHTML += "<button type='button' class='btn btn-danger btn-sm btn-delete' onclick='deleteOption(this)'>Delete</button>"
                    optionsList.innerHTML += "<button type='button' class='btn btn-info btn-sm btn-update' onclick='updateOption(this)'>Update</button>"
            ...
            document.getElementById('generate-products-btn').addEventListener('click', function () {
                ...
                combinations.forEach(function (combination) {
                    ...
                    tr.innerHTML = `<td>\${sku||""}<input type="hidden" name="sku" value="\${sku||""}"></td>
                            ...
                            <td><input type="checkbox" name="isStored" onclick="this.value = this.checked ? '\${sku}' : '0';" ></td>`;
